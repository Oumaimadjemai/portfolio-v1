...
export default function Experience() {
  const experiences = [
    ...
    },
    {
      ...
      responsibilities: [
        "Assisted in the maintenance and management of IT infrastructure",
        "Participated in troubleshooting hardware and software issues",
        "Provided technical support and contributed to daily IT operations",
      ],
    },
  ];
